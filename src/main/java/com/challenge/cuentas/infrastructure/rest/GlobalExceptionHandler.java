...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(IndicadorNoDisponibleException.class)
    public ResponseEntity<Map<String, String>> manejarIndicadorNoDisponible(IndicadorNoDisponibleException e) {
